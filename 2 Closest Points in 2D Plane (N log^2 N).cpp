...
int solve(int L, int R)//returns square of distance of closest two points in range [L,R] of pt.
{
	if(L==R)
		return 1e18;
	int M=(L+R)/2;
...
Solution 1: https://codeforces.com/contest/429/submission/91210463
